        ...
        <div id="ponerimagen" style="display: flex;">
            ...
            <div class="container-fluid">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre Cliente..." aria-describedby="basic-addon1" required id="nombre_cliente">
                    <input type="text" class="form-control" placeholder="Total Compra Cliente..." aria-describedby="basic-addon1" required id="total_cliente">

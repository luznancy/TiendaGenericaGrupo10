    ...
    <body>
        ...
        <div id="ponerimagen" style="display: flex;">
            ...
            <div class="container-fluid">
                ...
                <div id="error" class="alert alert-danger visually-hidden" role="alert">Error al actualizar el proveedor, verifique que el nit sea valido</div>
                ...
                <form id="form1">
                    <div class="input-group mb-3">
						...
						Proveedor</span> <input type="text" class="form-control" placeholder="Inserte nit aqui..." aria-describedby="basic-addon1" required id="nit_proveedor">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon2">Ciudad
						Proveedor</span> <input type="text" class="form-control" placeholder="Inserte nueva ciudad aqui..." aria-describedby="basic-addon2" required id="ciudad_proveedor">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon3">Direccion
						Proveedor</span> <input type="text" class="form-control" placeholder="Inserte nueva direccion aqui..." aria-describedby="basic-addon3" required id="direccion_proveedor">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon4">Nombre
						Proveedor</span> <input type="text" class="form-control" placeholder="Inserte nuevo nombre aqui..." aria-describedby="basic-addon4" required id="nombre_proveedor">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon5">Telefono
						Proveedor</span> <input type="text" class="form-control" placeholder="Inserte nuevo telef�no aqui..." aria-describedby="basic-addon5" required id="telefono_proveedor">
                    </div>
                </form>

                <button id="btn1" type="button" class="btn btn-warning" onclick="actualizar_proveedor()">
            ...
            <div id="botonesUsuarios" class="container-fluid">
                <div class="row">
                    <button id="btn1" type="button" class="btn btn-success" onclick="window.location.href='/insertarproveedor.jsp'">
						<i class="fas fa-plus-circle"></i> Agregar proveedor
					</button>
                    <button id="btn2" type="button" class="btn btn-danger" onclick="window.location.href='/eliminarproveedor.jsp'">
						<i class="fas fa-trash"></i> Eliminar proveedor
					</button>
                    <button id="btn3" type="button" class="btn btn-warning" onclick="window.location.href='/actualizarproveedor.jsp'">
						<i class="fas fa-pen-alt"></i> Actualizar proveedor
					</button>
                    <button id="btn4" type="button" class="btn btn-primary" onclick="window.location.href='/buscarproveedor.jsp'">
						<i class="fas fa-search"></i> Buscar un proveedor
					</button>
                    <button id="btn5" type="button" class="btn btn-primary" onclick="window.location.href='/listaproveedores.jsp'">
        ...
        <script>
            ...
            function actualizar_proveedor() {
                ...
                if (coincidencia != false) {
                    window
                        .alert("Voy a enviar la informaci�n del proveedor con nit " +
                            y);

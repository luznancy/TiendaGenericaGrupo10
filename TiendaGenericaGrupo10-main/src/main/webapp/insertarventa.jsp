        ...
        <nav class="navbar navbar-light" style="background-color: #F4FDB1">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listausuarios.jsp"> <i class="fas fa-users"></i> Usuarios
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listaclientes.jsp"> <i class="fas fa-address-book"></i> Clientes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listaproveedores.jsp"> <i class="fas fa-truck"></i> Proveedores
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listaproductos.jsp"> <i class="fas fa-apple-alt"></i> Productos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listaventas.jsp"> <i class="fas fa-money-check-alt"></i> Ventas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="listareportes.jsp"> <i class="fas fa-clipboard-list"></i> Reportes
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="container-fluid">
                ...
                <form id="form1">
                    <div class="input-group mb-3">
						...
						Cliente</span> <input type="text" class="form-control" placeholder="Inserte cedula cliente aqui..." aria-describedby="basic-addon1" required id="cedula_cliente">
                    </div>
                    <button type="button" class="btn btn-success" onclick="buscar_cliente_venta()">
						<i class="fas fa-check"></i> Buscar cliente
					</button>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Cliente </span> <input type="text" class="form-control" placeholder="Nombre cliente..." aria-describedby="basic-addon1" required id="nombre_cliente" disabled="disabled">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Cedula
						Usuario</span> <input type="text" class="form-control" placeholder="Inserte cedula usuario aqui..." aria-describedby="basic-addon1" required id="cedula_usuario">
                    </div>
                    <button type="button" class="btn btn-success" onclick="buscar_usuario_venta()">
                                <i class="fas fa-check"></i> Buscar usuario
                            </button>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Usuario </span> <input type="text" class="form-control" placeholder="Nombre usuario..." aria-describedby="basic-addon1" required id="nombre_usuario" disabled="disabled">

                    </div>
                    <div class="input-group mb-3">

                        <span class="input-group-text" id="basic-addon1">Consecutivo Venta </span> <input type="text" class="form-control" aria-describedby="basic-addon1" required id="cons_venta" disabled="disabled">
                    </div>
                    <div class="input-group mb-3">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Producto  1" aria-describedby="basic-addon1" required id="cod_prod1">
                            </div>


                            <div class="col">
                                <input type="text" class="form-control" placeholder="Nombre producto 1" aria-describedby="basic-addon1" required id="nom_prod1">
                            </div>

                            <div class="col">
                                <input type="text" class="form-control" placeholder="Cantidad p1" aria-describedby="basic-addon1" required id="cant_1">
                            </div>

                            <div class="row">Valor total</div>
                            <div class="row">
                                <input type="text" class="form-control" placeholder="Valor Total 1" aria-describedby="basic-addon1" required id="valort_1" value="0">
                            </div>



                            <div class="row">
                                <button type="button" class="btn btn-success" onclick="buscar_producto1_venta()">
            ...
            <div class="container-fluid">
                <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="col">Codigo producto</div>
                            <input type="text" class="form-control" placeholder="Producto  2" aria-describedby="basic-addon1" required id="cod_prod2">
                        </div>
                        ...
                        <div class="col">
                            <div class="col">Nombre producto</div>
                            <input type="text" class="form-control" placeholder="Nombre producto 2 " aria-describedby="basic-addon1" required id="nom_prod2">
                        </div>

                        <div class="col">
                            <div class="col">Cantidad</div>
                            <input type="text" class="form-control" placeholder="Cantidad p2" aria-describedby="basic-addon1" required id="cant_2">
                        </div>
                        <div class="row">Valor total</div>
                        <div class="row">
                            <input type="text" class="form-control" placeholder="Valor Total 2" aria-describedby="basic-addon1" required id="valort_2" value="0">
                        </div>

                        <div class="row">
                            <button type="button" class="btn btn-success" onclick="buscar_producto2_venta()">
								<i class="fas fa-check"></i> Consultar
							</button>
                        </div>
                    </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="col">Codigo producto</div>
                            <input type="text" class="form-control" placeholder="Producto  3" aria-describedby="basic-addon1" required id="cod_prod3">
                        </div>

                        <div class="col">
                            <div class="col">Nombre producto</div>
                            <input type="text" class="form-control" placeholder="Nombre producto 3" aria-describedby="basic-addon1" required id="nom_prod3">
                        </div>

                        <div class="col">
                            <div class="col">Cantidad</div>
                            <input type="text" class="form-control" placeholder="Cantidad p3" aria-describedby="basic-addon1" required id="cant_3">
                        </div>
                        <div class="row">Valor total</div>
                        <div class="row">
                            <input type="text" class="form-control" placeholder="Valor Total t3" aria-describedby="basic-addon1" required id="valort_3" value="0">
                        </div>
                        <div class="row">
                            <button type="button" class="btn btn-success" onclick="buscar_producto3_venta()">
                                    <i class="fas fa-check"></i> Consultar
                                </button>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <input type="text" class="form-control" placeholder="Total venta" aria-describedby="basic-addon1" required id="total_venta" disabled="disabled">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <input type="text" class="form-control" placeholder="Total Iva" aria-describedby="basic-addon1" required id="total_iva" disabled="disabled">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <input type="text" class="form-control" placeholder="Total Con IVA" aria-describedby="basic-addon1" required id="total_coniva" disabled="disabled">
                            </div>
                            <div class="row">
                                <button type="button" class="btn btn-success" onclick="enviar_venta()">
                                            <i class="fas fa-check"></i>Calcular
                                        </button>
                            </div>
                            <div class="row">
                                <button id="boton1" type="button" class="btn btn-success" onclick="registrar_venta()">

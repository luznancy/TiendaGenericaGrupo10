...
<body>
		...
		<div class="container-fluid">
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					...
					<span class="input-group-text" id="basic-addon1">Consecutivo
						Venta </span> <input type="text" class="form-control"
						aria-describedby="basic-addon1" required id="cons_venta"
						disabled="disabled">
				</div>
				<div class="input-group mb-3">
					<div class="row">
					...
					<div class="row">
						...
						<div class="row">
							<input type="text" class="form-control"
								...
								required id="valort_1" value="0" disabled="disabled">
						</div>
				...
				<div class="row">
					...
					<div class="row">
						<input type="text" class="form-control"
							...
							required id="valort_2" value="0" disabled="disabled">
					</div>
				...
				<div class="row">
					...
					<div class="row">
						<input type="text" class="form-control"
							...
							required id="valort_3" value="0" disabled="disabled">
					</div>
					<div class="row">
						<button type="button" class="btn btn-success"
			...
			<div class="row">
				...
				<div class="row">
					<input type="text" class="form-control" placeholder="Total venta"
						aria-describedby="basic-addon1" required id="total_venta"
						disabled="disabled">
				</div>
				...
				<div class="row">
					...
					<div class="row">
						<input type="text" class="form-control" placeholder="Total Iva"
							aria-describedby="basic-addon1" required id="total_iva"
							disabled="disabled">
					</div>
	...
	<nav class="navbar navbar-light" style="background-color: #F4FDB1">
		<div class="row justify-content-between">
			<div class="col-4">
				<a class="navbar-brand links" href="#"> Dise�ado por Grupo 10 </a>
			</div>
		</div>
	</nav>
	<script>
		...
		function registrar_venta() {
			...
			if (conta_detalle_1 == 0 && conta_detalle_2 == 0
					&& conta_detalle_3 == 0) {
				window.alert("Ingrese al menos un producto");
				location.reload();
			} else {
				var formDataVenta = new FormData();
				formDataVenta.append("codigo_venta", document
						.getElementById("cons_venta").value);
				formDataVenta.append("cedula_cliente", document
						.getElementById("cedula_cliente").value);
				formDataVenta.append("cedula_usuario", document
						.getElementById("cedula_usuario").value);
				formDataVenta.append("iva_venta", document
						.getElementById("total_iva").value);
				formDataVenta.append("total_venta", document
						.getElementById("total_venta").value);
				formDataVenta.append("valor_venta", document
						.getElementById("total_coniva").value);
				...
				conta_venta.open('GET',
						'http://localhost:8080/contardetalleventa', false);
				...
				if (document.getElementById("nom_prod1").value != "") {
					...
					primer_producto.append("codigo_detalle_venta",
							contador_venta);
					primer_producto.append("cantidad_producto",
							parseInt(document.getElementById("cant_1").value));
					primer_producto.append("codigo_producto", parseInt(document
							.getElementById("cod_prod1").value));
					primer_producto.append("codigo_venta", parseInt(document
							.getElementById("cons_venta").value));
					primer_producto.append("valor_total", parseFloat(document
							.getElementById("valort_1").value));
				...
				if (document.getElementById("nom_prod2").value != "") {
					...
					segundo_producto.append("codigo_detalle_venta",
							contador_venta);
					segundo_producto.append("cantidad_producto",
							parseInt(document.getElementById("cant_2").value));
					segundo_producto
							.append("codigo_producto", parseInt(document
									.getElementById("cod_prod2").value));
					segundo_producto.append("codigo_venta", parseInt(document
							.getElementById("cons_venta").value));
					segundo_producto.append("valor_total", parseFloat(document
							.getElementById("valort_2").value));
				...
				if (document.getElementById("nom_prod3").value != "") {
					...
					tercer_producto.append("codigo_detalle_venta",
							contador_venta);
					tercer_producto.append("cantidad_producto",
							parseInt(document.getElementById("cant_3").value));
					tercer_producto.append("codigo_producto", parseInt(document
							.getElementById("cod_prod3").value));
					tercer_producto.append("codigo_venta", parseInt(document
							.getElementById("cons_venta").value));
					tercer_producto.append("valor_total", parseFloat(document
							.getElementById("valort_3").value));
